  ...
  const paths = {
    ...
    building: (
      <>
        ...
        <path d="M8 7h4M8 11h4M8 15h4M8 19h4M19 14h1M19 18h1" />
      </>
    ),

    kanban: (
      <>
        <path d="M4 5h6v10H4zM14 5h6v6h-6zM14 15h6v4h-6z" />
      </>
    ),
...
const linkClass = ({ isActive }) =>
  `group nav-link relative flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition ${
    isActive
      ? 'nav-active bg-white/[.08] text-white'
    ...
    <div className="crm-shell min-h-screen bg-[#f6f8fb] text-slate-900">
      ...
      <aside className="crm-sidebar fixed inset-y-0 left-0 z-40 hidden w-[252px] flex-col border-r border-white/5 bg-[#0c1320] px-4 py-5 lg:flex">
        ...
        <div className="flex items-center gap-3 px-2 pb-9">
          <div className="grid h-10 w-10 place-items-center rounded-[13px] bg-gradient-to-br from-emerald-300 to-cyan-300 text-[15px] font-extrabold text-[#0c1320] shadow-lg shadow-emerald-300/10">
            A
          </div>
          ...
          <div>
            ...
            <div className="text-[9px] uppercase tracking-[.22em] text-slate-500">
              CRM workspace
            </div>
          </div>
        </div>

        <div className="px-2 pb-2 text-[9px] font-bold uppercase tracking-[.2em] text-slate-600">
          Workspace
        </div>
        ...
        <div className="mt-auto rounded-2xl border border-white/[.07] bg-white/[.035] p-3">
          ...
          <div className="mb-3 flex items-center gap-3">
            <div className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-gradient-to-br from-emerald-300 to-cyan-300 text-sm font-bold text-slate-900">
      ...
      {mobileOpen && (
        <button
          ...
          type="button"
          className="crm-mobile-overlay lg:hidden"
          onClick={closeMobile}
        />
      )}
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`crm-mobile-drawer lg:hidden ${
          mobileOpen ? 'is-open' : ''
        }`}
      ...
      >
        ...
        <div className="flex items-center justify-between px-2 pb-8">
          ...
          <div className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-[13px] bg-gradient-to-br from-emerald-300 to-cyan-300 text-[15px] font-extrabold text-[#0c1320]">
              A
            </div>
      ...
      <div className="lg:pl-[252px]">
        ...
        <header className="sticky top-0 z-30 flex h-[70px] items-center justify-between border-b border-slate-200/80 bg-white/90 px-4 backdrop-blur-xl sm:px-5 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:grid lg:hidden h-9 w-9 place-items-center rounded-xl bg-slate-900 text-sm font-bold text-white">
              A
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="grid h-9 w-9 place-items-center rounded-full border border-slate-200 bg-slate-50 text-xs font-bold text-slate-700 lg:hidden">
              {(user?.name || 'U').slice(0, 1).toUpperCase()}
            </div>
        ...
        <main className="crm-main px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
          <Outlet />
        </main>
